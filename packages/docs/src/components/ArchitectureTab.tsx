...
const packages: PackageInfo[] = [
  ...
  },
  {
    ...
    modules: [
      { name: "StateStore", description: "Goals, messages, rules, phases — all persisted to SQLite" },
      { name: "GoalTracker", description: "Goal state machine with transition validation" },
      { name: "AgentSession", description: "MessageQueue + Claude Code SDK wrapper" },
      { name: "Config", description: "Project config loader and path resolution" },
    ],
    x: 380,
    y: 240,
    width: 220,
  ...
  },
  {
    ...
    modules: [
      { name: "projects", description: "Project metadata, path, created/updated timestamps" },
      { name: "project_state", description: "Phase, total cost per project" },
      { name: "goals", description: "Goals with status, criteria, approach, retries, cost" },
      { name: "rules", description: "User-defined rules that constrain agent behavior" },
      { name: "messages", description: "Chat history between user and agent" },
      { name: "sessions", description: "Claude Code session tracking per phase/goal" },
    ],
    x: 280,
    y: 440,
    width: 220,
